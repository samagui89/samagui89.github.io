...
function handleClick(myRadio) {
    ...
    ? (
        ...
        document.documentElement.style.setProperty("--top-gradient", "linear-gradient(180deg, rgb(76,76,76,1) 0%, rgb(76,76,76,1) 50%, rgba(0,0,0,0.7) 100%)"),
    ...
    : (
        ...
        document.documentElement.style.setProperty("--top-gradient", "linear-gradient(180deg, rgb(237,237,237,1) 0%, rgb(237,237,237,1) 50%, rgba(230,230,230,0.7) 100%)"),
